...
from utils import SPMM_decoder, molT5_encoder
import time
...
def main(args):
    ...
    test_dataset = chebi20_dataset(['./data/chebi_20/test_parsed.txt'], data_length=None, shuffle=False, unconditional=False, raw_description=True)
